...
\warning The message context pointer, the format string parameters and the
    ...
    MediaOpenCb = ctypes.CFUNCTYPE(
        ctypes.POINTER(
            ctypes.c_int), ctypes.c_void_p, ListPOINTER(
...
\param picture private pointer returned from the @ref libvlc_video_lock_cb
    ...
    VideoFormatCb = ctypes.CFUNCTYPE(
        ctypes.POINTER(
            ctypes.c_uint), ListPOINTER(
            ctypes.c_void_p), ctypes.c_char_p, ctypes.POINTER(
                ctypes.c_uint), ctypes.POINTER(
                    ctypes.c_uint), ctypes.POINTER(
                        ctypes.c_uint), ctypes.POINTER(
                            ctypes.c_uint))
...
\param pts time stamp of the pause request (should be elapsed already)
    '''
    AudioResumeCb = ctypes.CFUNCTYPE(
...
class Instance(_Ctype):
    ...
    def audio_output_enumerate_devices(self):
        ...
        if head:
            ...
            while i:
                ...
                r.append(
                    {'name': i.name, 'description': i.description, 'devices': d})
                i = i.next
    ...
    def set_user_agent(self, name, http):
        ...
        '''
        return libvlc_set_user_agent(
            self, str_to_bytes(name), str_to_bytes(http))
    ...
    def set_app_id(self, id, version, icon):
        ...
        '''
        return libvlc_set_app_id(self, str_to_bytes(
            id), str_to_bytes(version), str_to_bytes(icon))
    ...
    def vlm_add_broadcast(self, psz_name, psz_input, psz_output,
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_add_broadcast(self, str_to_bytes(psz_name), str_to_bytes(
            psz_input), str_to_bytes(psz_output), i_options, ppsz_options, b_enabled, b_loop)
    ...
    def vlm_add_vod(self, psz_name, psz_input, i_options,
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_add_vod(self, str_to_bytes(psz_name), str_to_bytes(
            psz_input), i_options, ppsz_options, b_enabled, str_to_bytes(psz_mux))
    ...
    def vlm_set_output(self, psz_name, psz_output):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_output(self, str_to_bytes(
            psz_name), str_to_bytes(psz_output))
    ...
    def vlm_set_input(self, psz_name, psz_input):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_input(self, str_to_bytes(
            psz_name), str_to_bytes(psz_input))
    ...
    def vlm_add_input(self, psz_name, psz_input):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_add_input(self, str_to_bytes(
            psz_name), str_to_bytes(psz_input))
    ...
    def vlm_set_mux(self, psz_name, psz_mux):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_mux(self, str_to_bytes(
            psz_name), str_to_bytes(psz_mux))

    def vlm_change_media(self, psz_name, psz_input, psz_output,
                         i_options, ppsz_options, b_enabled, b_loop):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_change_media(self, str_to_bytes(psz_name), str_to_bytes(
            psz_input), str_to_bytes(psz_output), i_options, ppsz_options, b_enabled, b_loop)
    ...
    def vlm_seek_media(self, psz_name, f_percentage):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_seek_media(
            self, str_to_bytes(psz_name), f_percentage)
    ...
    def vlm_get_media_instance_title(self, psz_name, i_instance):
        ...
        '''
        return libvlc_vlm_get_media_instance_title(
            self, str_to_bytes(psz_name), i_instance)
    ...
    def vlm_get_media_instance_chapter(self, psz_name, i_instance):
        ...
        @bug: will always return 0.
        '''
        return libvlc_vlm_get_media_instance_chapter(
            self, str_to_bytes(psz_name), i_instance)
    ...
    def vlm_get_media_instance_seekable(self, psz_name, i_instance):
        ...
        @bug: will always return 0.
        '''
        return libvlc_vlm_get_media_instance_seekable(
            self, str_to_bytes(psz_name), i_instance)
...
class Media(_Ctype):
    ...
    def tracks_get(self):
        ...
        info = ctypes.cast(
            ctypes.mediaTrack_pp, ctypes.POINTER(
                ctypes.POINTER(MediaTrack) * n))
        return info
    ...
    def add_option_flag(self, psz_options, i_flags):
        ...
        '''
        return libvlc_media_add_option_flag(
...
class MediaPlayer(_Ctype):
    ...
    def video_get_chapter_description(self, title):
        ...
        """
        return track_description_list(
            libvlc_video_get_chapter_description(self, title))
    ...
    def get_full_title_descriptions(self):
        ...
        info = ctypes.cast(
            ctypes.titleDescription_pp, ctypes.POINTER(
                ctypes.POINTER(TitleDescription) * n))
        return info
    ...
    def get_full_chapter_descriptions(self, i_chapters_of_title):
        ...
        n = libvlc_media_player_get_full_chapter_descriptions(
            self, ctypes.byref(chapterDescription_pp))
        info = ctypes.cast(
            ctypes.chapterDescription_pp, ctypes.POINTER(
                ctypes.POINTER(ChapterDescription) * n))
        return info
    ...
    def video_set_format(self, chroma, width, height, pitch):
        ...
        '''
        return libvlc_video_set_format(
            self, str_to_bytes(chroma), width, height, pitch)
    ...
    def set_android_context(self, p_jvm, p_awindow_handler):
        ...
        @version: LibVLC 3.0.0 and later.
        '''
        return libvlc_media_player_set_android_context(
            self, p_jvm, p_awindow_handler)
    ...
    def audio_set_format(self, format, rate, channels):
        ...
        @version: LibVLC 2.0.0 or later.
        '''
        return libvlc_audio_set_format(
            self, str_to_bytes(format), rate, channels)
    ...
    def set_video_title_display(self, position, timeout):
        ...
        @version: libVLC 2.1.0 or later.
        '''
        return libvlc_media_player_set_video_title_display(
    ...
    def video_set_marquee_string(self, option, psz_text):
        ...
        '''
        return libvlc_video_set_marquee_string(
            self, option, str_to_bytes(psz_text))
    ...
    def video_set_logo_string(self, option, psz_value):
        ...
        '''
        return libvlc_video_set_logo_string(
            self, option, str_to_bytes(psz_value))
...
def libvlc_media_new_callbacks(
        instance, open_cb, read_cb, seek_cb, close_cb, opaque):
    '''Create a media with custom callbacks to read the data from.
...
if __name__ == '__main__':
    ...
    if sys.argv[1:] and sys.argv[1] not in ('-h', '--help'):
        ...
        event_manager.event_attach(
            EventType.MediaPlayerEndReached, end_callback)
        event_manager.event_attach(
